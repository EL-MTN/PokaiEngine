...
describe('PotManager', () => {
	...
	describe('Basic Pot Distribution', () => {
		...
		it('should distribute single pot to single winner', () => {
			...
			const distributions = potManager.distributePots([{ playerId: 'p1', potIndices: [0] }]);
	...
	describe('Simulation Methods', () => {
		...
		it('should simulate with position-based odd chips', () => {
			...
			const p2Distribution = result.distributions.find((d) => d.playerId === 'p2');
	...
	describe('Edge Cases and Error Handling', () => {
		...
		it('should handle all players folded', () => {
			const players = [new Player('p1', 'Alice', 1000), new Player('p2', 'Bob', 1000)];
