...
import { Action, ActionType, Position, Suit, Rank } from '@/domain/types';
...
describe('Player', () => {
	...
	describe('Clone Method', () => {
		...
		it('should create exact copy of player', () => {
			...
			expect(clonedPlayer.totalBetThisHand).toBe(originalPlayer.totalBetThisHand);
			expect(clonedPlayer.isConnected).toBe(originalPlayer.isConnected);
			expect(clonedPlayer.actionsThisRound).toEqual(originalPlayer.actionsThisRound);
